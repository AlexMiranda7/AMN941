...
f1=input('Introduzca la funcion f1= ');
f2=input('Introduzca la funcion f2= ');
...
%Jfila1=[f11,f12];
%Jfila2=[f21,f22];
%MatrixJ=[Jfila1;Jfila2];
%fprintf('Matriz J(x) =\n');
%disp(MatrixJ);
fprintf('\n');


x1=input('Introduzca el valor de x1^(0)= ');
x2=input('Introduzca el valor de x2^(0)= ');
